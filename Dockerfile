...
# Install java & git
RUN (apt-get install software-properties-common git-core wget -y && apt-add-repository ppa:webupd8team/java -y && apt-get update && echo oracle-java7-installer shared/accepted-oracle-license-v1-1 select true | sudo /usr/bin/debconf-set-selections && apt-get install oracle-java7-installer -y)
